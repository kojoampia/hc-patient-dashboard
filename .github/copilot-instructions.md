...
- There is no Maven here — `pom.xml`, `mvnw` and the `backend:*` scripts were deleted on 2026-09-24 (`docs/backlog.md` item 70); this repo never had a Java source. Ignore any generated instruction that reaches for `./mvnw`.
