package net.jojoaddison.hc.web.rest;

import static net.jojoaddison.hc.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import java.time.Instant;
import java.util.*;
import net.jojoaddison.hc.IntegrationTest;
import net.jojoaddison.hc.config.Constants;
import net.jojoaddison.hc.domain.User;
import net.jojoaddison.hc.repository.AuthorityRepository;
import net.jojoaddison.hc.repository.UserRepository;
import net.jojoaddison.hc.security.AuthoritiesConstants;
import net.jojoaddison.hc.service.UserService;
import net.jojoaddison.hc.service.dto.AdminUserDTO;
import net.jojoaddison.hc.service.dto.PasswordChangeDTO;
import net.jojoaddison.hc.service.dto.UserDTO;
import net.jojoaddison.hc.web.rest.vm.KeyAndPasswordVM;
import net.jojoaddison.hc.web.rest.vm.ManagedUserVM;
