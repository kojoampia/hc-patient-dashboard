...
import { EntityArrayResponseType, MembershipService } from '../service/membership.service';
...
export class MembershipComponent implements OnInit {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.memberships = this.refineData(dataFromBody);
  }

  protected refineData(data: IMembership[]): IMembership[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IMembership[] | null): IMembership[] {
    return data ?? [];
  }
