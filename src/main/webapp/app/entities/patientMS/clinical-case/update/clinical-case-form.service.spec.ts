...
import { sampleWithRequiredData, sampleWithNewData } from '../clinical-case.test-samples';
  ...
  describe('Service methods', () => {
    ...
    describe('getClinicalCase', () => {
      it('should return NewClinicalCase for default ClinicalCase initial value', () => {
        ...
        const clinicalCase = service.getClinicalCase(formGroup) as any;
