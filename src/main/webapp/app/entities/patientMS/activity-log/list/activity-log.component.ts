...
import { EntityArrayResponseType, ActivityLogService } from '../service/activity-log.service';
...
export class ActivityLogComponent implements OnInit {
  ...
  trackId = (_index: number, item: IActivityLog): string => this.activityLogService.getActivityLogIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.activityLogs = dataFromBody;
  }
