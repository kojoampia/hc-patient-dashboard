...
export class ProfessionalComponent implements OnInit {
  ...
  trackId = (_index: number, item: IProfessional): string => this.professionalService.getProfessionalIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.professionals = this.refineData(dataFromBody);
  }
